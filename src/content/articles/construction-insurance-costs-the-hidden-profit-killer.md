...
- **Deductibles rising, straining [cash flow](/article/5-cash-flow-mistakes-that-kill-construction-companies/).** To offset premium increases, carriers are pushing $10,000-$25,000 deductibles, directly impacting working capital.
...
General liability premiums increased 25% on average in 2025 due to rising claim frequency, increased litigation costs, carrier exits from the [construction market](/article/construction-market-intelligence-march-6-2026-conexpo-unleashes-autonomous-equipment-as-agc-launches-2m-infrastructure-campaign/) reducing competition, and climate-related losses. Workers' comp costs also rose 10-15% in many states due to medical cost inflation and benefit requirement increases. Supply chain disruptions and skilled labor shortages have also increased claim severity.
...
- **Integrate insurance into bidding.** Use [construction project management software](/article/construction-project-management-surviving-the-messy-middle/) to allocate insurance costs as percentage markups by trade in every estimate. This ensures jobs are bid with accurate overhead loads.
